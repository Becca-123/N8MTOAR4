...
@EndUserText.label: 'MES工單元件拋轉LOG Projection View'
@UI: {
     headerInfo: {
                typeName: '工單元件',
                typeNamePlural: '工單元件'
...
define root view entity ZZ1_PV_POCOMPONENTMESLOG 
    provider contract transactional_query as projection on ZZ1_I_POHDMESLOG
{
    ...
    key serial_no,
        ...
        @Consumption.valueHelpDefinition: [ { entity: { name: 'I_User', element: 'GoodsMovementType' } } ]    
